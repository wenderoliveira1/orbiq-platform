-- ===========================================================
-- ORBIQ PLATFORM
-- QUOTE SERVICES: QUANTITY + FINAL TOTAL
-- ===========================================================
...
begin
    ...
    loop
        ...
        if service_catalog_id is not null then
            ...
            service_unit_labor_amount := coalesce((service_entry ->> 'labor_amount')::numeric, 0);

            if char_length(service_description) < 2 then
                raise exception 'Service description is required';
            end if;
            if service_unit_labor_amount < 0 or service_unit_labor_amount > 1000000 then
